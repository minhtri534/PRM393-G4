  ...
  Widget _buildBody(AnnotatorProvider provider, List filtered) {
    ...
    if (provider.listState == AnnotatorLoadState.error &&
      ...
      return error_widget.ErrorWidget(
        ...
        onRetry: () => provider.fetchTasks(projectId: widget.project.id),
      );
    }
    ...
    return RefreshIndicator(
      onRefresh: () => provider.fetchTasks(projectId: widget.project.id),
          ...
          return TaskCard(
            ...
            onStart: () async {
              ...
              if (result == true && context.mounted) {
                provider.fetchTasks(projectId: widget.project.id);
              }
            },
          );
        },
