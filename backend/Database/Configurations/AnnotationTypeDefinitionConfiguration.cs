...
public sealed class AnnotationTypeDefinitionConfiguration : IEntityTypeConfiguration<AnnotationTypeDefinition>
{
    public void Configure(EntityTypeBuilder<AnnotationTypeDefinition> builder)
    {
